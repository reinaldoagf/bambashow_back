...
<head>
  ...
  <style type="text/css">
    ...
    * {
    ...
    .grid_link .link_content {
      display: table-cell;
      width: 90%;
      padding: 20px 0;
    }

    .grid_link .link_content h1 {
      font-size: 18px;
      line-height: 24px;
      color: #1db8af;
      font-weight: 500;
    ...
    .grid_link .link_content h3 span {
      color: #1db8af;
      margin: 0 10px 0px 0px;
      line-height: 20px;
    }

    .grid_link .link_content p {
      font-size: 14px;
      text-align: left;
      margin: 0;
      line-height: 24px;
    ...
    .grid_link .link_button {
      display: table-cell;
      width: 10%;
      vertical-align: middle;
    }

    .grid_link .link_button a img {
      width: 80px;
    }
  </style>
  ...
  <div class="wrapper" style="min-width: 320px;background-color: #f5f7fa;" lang="x-wrapper">
    <div class="preheader" style="Margin: 0 auto;max-width: 560px;min-width: 280px; width: 280px;width: calc(28000% - 173040px);">
      <div style="border-collapse: collapse;display: table;width: 100%;">
        ...
        <div class="snippet" style="Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 140px; width: 140px;width: calc(14000% - 78120px);padding: 10px 0 5px 0;color: #b9b9b9;font-family: Lato,Tahoma,sans-serif;">

        </div>
        <!--[if (mso)|(IE)]></td><td style="width: 280px" valign="top"><![endif]-->
        <div class="webversion" style="Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 139px; width: 139px;width: calc(14100% - 78680px);padding: 10px 0 5px 0;text-align: right;color: #b9b9b9;font-family: Lato,Tahoma,sans-serif;">
      ...
      <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #307fb0;background-position: 0px 0px;background-image: url(https://trello-attachments.s3.amazonaws.com/574cdfb876aa19ff03c01424/1200x412/57ca4ffca60f7f513a0a355e41fdc00c/emailheader.png);background-repeat: repeat;">
        ...
        <div class="column" style="text-align: left;color: #60666d;font-size: 14px;line-height: 21px;font-family: sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
          ...
          <div style="Margin-left: 20px;Margin-right: 20px;">
            <h1 class="size-36" style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #fff;font-size: 28px;line-height: 38px;text-align: center;" lang="x-size-36"><strong>Bamba<br>show</strong></h1>
          </div>
          ...
          <div style="font-size: 12px;font-style: normal;font-weight: normal;" align="center">
            <img style="border: 0;display: block;height: auto;width: 100%;max-width: 120px;" alt="" width="120" src="https://trello-attachments.s3.amazonaws.com/574cdfb876aa19ff03c01424/451x130/0f1b73a2ece9940d2525bf027012bda9/QSearchLogoV3_center.png" />
          </div>
      ...
      <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #37a69d;">
        ...
        <div class="column" style="text-align: left;color: #60666d;font-size: 14px;line-height: 21px;font-family: sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
          ...
          <div style="Margin-left: 40px;Margin-right: 20px;Margin-top: 15px;Margin-bottom: 15px;">
            <p style="Margin-top: 0;Margin-bottom: 0;"><span style="color:#ffffff">感謝您對 Linkbundle 的支持，您的購買明細如下：</span></p>
          </div>
      ...
      <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;" emb-background-style>
        ...
        <div class="column" style="margin-text-align: left;color: #60666d;font-size: 14px;line-height: 21px;font-family: sans-serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);">
          ...
          <div style="Margin-left: 40px;Margin-right: 20px;Margin-top: 24px;">
            <h2 class="size-24" style="Margin-top: 0;Margin-bottom: 16px;font-style: normal;font-weight: normal;color: #717c8a;font-size: 20px;line-height: 28px;" lang="x-size-24"><strong>Order Summary</strong></h2>
          </div>
    ...
    <div class="layout three-col fixed-width" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 173000px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
      ...
      <div class="layout__inner" style="color:#717c8a;background-color: #ffffff;padding-left:40px;padding-right:20px;padding-bottom:20px;font-family:helvetica neue;font-size: 14px;line-height: 24px;font-weight:400;">

        您已經購買了 <strong>test</strong> 個月份的 Linkbundle 專業版
      </div>
      <div class="layout__inner" style="color:gray;background-color: #ffffff;padding-left:40px;padding-right:20px;padding-bottom:20px;font-family:helvetica neue;font-size: 12px;line-height: 24px;font-weight:400;">
        提醒您，請詳填發票資訊以便我們將統一發票寄送給您。<a href="https://analytics.qsearch.cc/linkbundle?vw=settings_billing">立即前往修改</a>
      </div>
      <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;border-top:#e0e0e0 1px solid;border-bottom:#e0e0e0 1px solid;box-sizing: border-box;" emb-background-style>
        ...
        <div class="column" style="text-align: left;color: #60666d;font-size: 12px;line-height: 21px;font-family: sans-serif;Float: left;max-width: 320px;min-width: 196px; width: 320px;width: calc(72200px - 12000%);border:#e0e0e0 1px solid;box-sizing: border-box;border-bottom: none;">
          ...
          <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 16px;">
            <p style="Margin-top: 20px;Margin-bottom: 0;text-align: center;color:#9e9e9e;font-size: 13px;line-height: 10px;letter-spacing: 0.5px;font-weight: 600">開始日期</p>
          </div>
